export const greek_7x7_20240104 = {
	across: {
		/// fix numbers
		1: { clue: "Τοποθετειται κατα μερος για μελλοντικη χρηση, αποταμιευμα.", answer: "αποθηκη" },
		3: { clue: "Αυτο που δε λαμβανει η δεν ελαβε μερος σε κατι", answer: "αποκλεισμενος" },
		5: { clue: "Ευκινητοι, γρηγοροι.", answer: "αμεσοι" },
	},
	down: [],
}

export const nyt_mini_20240104 = {
	size: [5, 5],
	spots: {
		1: { row: 0, col: 1 },
		2: { row: 0, col: 2 },
...
export const exampleCrosser = nyt_mini_20240104
